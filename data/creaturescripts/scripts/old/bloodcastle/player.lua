...
function onLogin(cid)
     if isInArea(getCreaturePosition(cid), bloodconfig.fromPos, bloodconfig.toPos) then
          ...
          doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Você estava no meio do evento Blood Castle quando o servidor caiu. Você foi teleportado para o templo.")
     end
