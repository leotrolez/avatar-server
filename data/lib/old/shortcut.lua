...
function doPlayerSetExperienceRate(cid, value)
  return doPlayerSetRate(cid, SKILL_LEVEL, value)
end

function doPlayerSetMagicRate(cid, value)
  return doPlayerSetRate(cid, SKILL_MAGLEVEL, value)
end
...
function getItemPluralNameById(itemid)
  return ItemType(itemid):getPluralName()
end

function getItemArticleById(itemid)
  return ItemType(itemid):getArticle()
end
...
function getCurrentFold(cid)
  return getPlayerStorageValue(cid, "currentFold"):lower()
end