local npcGen = newNpc("tasksGeralNpc")

npcGen:setHiMsg("Hello %s! I have some TASKs brave adventurer! Are you interested?", "Olá %s! Eu tenho algumas TASKs jovem aventureiro, você está interessado?")
