	...
	if not talkState[talkUser] or talkState[talkUser] <= 0 then
        ...
        if talkState[talkUser] == 1 then
            if msgcontains(msg, "routes") or msgcontains(msg, "rotas") or msgcontains(msg, "travel") then
                selfSay(getLangString(cid, "I can take you to: {South Air Temple} or {Ba Sing Se} for 50 gold coins.", "Eu posso levar você para: {South Air Temple} ou {Ba Sing Se} por 50 gold coins."), cid)
