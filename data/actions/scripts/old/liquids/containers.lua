...
setConditionParam(poison, CONDITION_PARAM_DELAYED, 1) -- Condition will delay the first damage from when it's added
...
setConditionParam(poison, CONDITION_PARAM_FORCEUPDATE, 1) -- Re-update condition when adding it(ie. min/max value)

local burn = createConditionObject(CONDITION_FIRE)
setConditionParam(burn, CONDITION_PARAM_DELAYED, 1) -- Condition will delay the first damage from when it's added
...
setConditionParam(burn, CONDITION_PARAM_FORCEUPDATE, 1) -- Re-update condition when adding it(ie. min/max value)
