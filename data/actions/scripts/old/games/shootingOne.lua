local config = {
   enter = {x=503,y=337,z=8},
   exit = {x=505,y=337,z=8},
   clock = {x=497,y=333,z=8,time=60},
   totalPoses = registrePosesBetween({x=497,y=334,z=8}, {x=499,y=339,z=8}),
