...
class Events
{
	...
	public:
		...
		bool eventPlayerOnCastSpell(Player* player, const InstantSpell* spell);
		bool eventPlayerOnMove(Creature* creature, Direction direction);
