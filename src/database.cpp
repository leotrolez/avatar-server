...
bool Database::connect()
{
	...
	// --- CORREÇÃO DEFINITIVA PARA SSL (MariaDB/MySQL) ---
		// Força o desligamento de SSL e verificações de certificado
	bool ssl_false = false;
	mysql_options(handle, MYSQL_OPT_SSL_ENFORCE, &ssl_false);
	mysql_options(handle, MYSQL_OPT_SSL_VERIFY_SERVER_CERT, &ssl_false);
	// ----------------------------------------------------
