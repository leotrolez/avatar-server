...
class ScriptEnvironment
{
	...
	private:
		...
		using StorageMap = std::map<std::string, std::string>;
...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaDoCreatureSetMoveImmuneTime(lua_State* L);
		static int luaGetCreatureMoveImmuneTime(lua_State* L);
		...
		static int luaUniformRandom(lua_State* L);
		...
		static int luaItemHasEquipEvent(lua_State* L);
		...
		static int luaPlayerAddMagicLevel(lua_State* L);
