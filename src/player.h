...
class Player final : public Creature, public Cylinder
{
	public:
		...
		uint16_t getVocationEmblem() const;
		...
		void addStorageValue(const std::string& key, int32_t value, const bool isLogin = false);
		void addStorageValue(const std::string& key, std::string strValue, const bool isLogin = false);
		bool getStorageValue(const std::string& key, std::string& value) const;
		bool getStorageValue(const std::string& key, int32_t& value) const;
